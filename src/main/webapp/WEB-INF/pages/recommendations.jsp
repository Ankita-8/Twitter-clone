 ...
 <html lang="en" class=""><head>
       ...
       <style class="INLINE_PEN_STYLESHEET_ID">
          ...
          --cs-surface-2: #eef4f8;
          --cs-separator: #e8ecf0;
          --cs-on-surface-primary: #5C5858;
          --cs-on-surface-secondary: #837E7C;
                                    ...
                                    <div class="joke">
                                       <div class="joke_wrapper">
                                          <div class="joke_block joke_block--header">
                                             <span class="joke_element joke_element--author-name">${members.name}</span><span class="joke_element joke_element--author-username">${members.email}</span>
                                             <div class="joke_element joke_element--author-img"><img src="/static/images/default-user.jpg"></div>
                                          </div>
                                         <c:if test = "${members.is_followed}">
                                                <button class="follow-member followed-button" member-id = "${members.id}" type="submit" tabindex="0" style="margin-top: 20px;">
                                                <span tabindex="-1">Followed</span>
                                                </button>
                                         </c:if>
                                         <c:if test = "${not members.is_followed}">
                                                    <button class="follow-member" member-id = "${members.id}" type="submit" tabindex="0" style="margin-top: 20px;">
